...
# Хранилище сгенерированных паролей
passwords = []
# Хранилище вводимых пользователем аргументов
user_data = []
# Хранилище вопросов к пользователю
...
# Хранилища строк различных символов
...
def user_param():
    ...
    # Передача параметров длина и количество в генератор паролей
    generate_password()
